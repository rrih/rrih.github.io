...
import { ToolsView, ViewModeToggle } from '@/components/home/view-mode-toggle'
...
export default function HomeClient() {
  const [viewMode, setViewMode] = useState<'rich' | 'simple'>('rich')
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-4">
        <main>
          ...
          <section id="tools" className="mb-20">
            ...
            <ToolsView tools={featuredTools} viewMode={viewMode} ToolCard={ToolCard} />
          </section>
          ...
          {allTools.length > 0 && (
            <section className="mb-20">
              ...
              <ToolsView tools={allTools} viewMode={viewMode} ToolCard={ToolCard} />
            </section>
          )}
