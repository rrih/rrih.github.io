        ...
        <main>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <section className="mb-12">
              ...
              <p>
                You retain ownership of your content, but grant us the right to process it 
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                ...
                intellectual property laws. The source code is available under open source 
                licenses as specified in our repository.
              </p>
              <p>
                You may not copy, modify, distribute, or create derivative works of our 
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                ...
                IMPLIED. WE DISCLAIM ALL WARRANTIES, INCLUDING BUT NOT LIMITED TO WARRANTIES 
            ...
            <section className="mb-12">
              ...
              <p>
                ...
                (which is currently zero for free tools).
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="mb-4">
                ...
                part thereof) at any time without notice. We may also implement new features, 
                including premium services or advertising.
              </p>
            </section>
