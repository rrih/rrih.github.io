              ...
              <div className="p-3 sm:p-4 md:p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={state.delay}
                      onChange={(e) =>
                        setState((prev) => ({ ...prev, delay: Number.parseFloat(e.target.value) }))
                      }
                      className="w-full rounded-lg border border-border-light px-3 py-2 text-sm bg-white dark:border-border-dark dark:bg-background-dark focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20"
                    />
                  </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setState((prev) => ({ ...prev, timingFunction: e.target.value }))
                    }
                    className="w-full rounded-lg border border-border-light px-3 py-2 text-sm bg-white dark:border-border-dark dark:bg-background-dark focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20"
                  >
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setState((prev) => ({ ...prev, iterationCount: e.target.value }))
                      }
                      className="w-full rounded-lg border border-border-light px-3 py-2 text-sm bg-white dark:border-border-dark dark:bg-background-dark focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setState((prev) => ({ ...prev, fillMode: e.target.value }))}
                      className="w-full rounded-lg border border-border-light px-3 py-2 text-sm bg-white dark:border-border-dark dark:bg-background-dark focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20"
                    >
                      {fillModes.map((mode) => (
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex gap-2">
                      {(['square', 'rounded', 'circle'] as const).map((shape) => (
                        <button
                          key={shape}
                          onClick={() => setState((prev) => ({ ...prev, previewShape: shape }))}
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateKeyframe(keyframe.id, { backgroundColor: e.target.value })
                            }
