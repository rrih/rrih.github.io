...
export default function AnimationGeneratorPage() {
  ...
  const [savedState, setSavedState, clearSavedState] =
    useToolState<AnimationState>(TOOL_NAME, initialState);
  ...
  const generateKeyframes = useCallback(() => {
    return state.keyframes
      ...
      .map((keyframe) => {
        const transforms = [];
        if (keyframe.translateX !== 0)
          transforms.push(`translateX(${keyframe.translateX}px)`);
        if (keyframe.translateY !== 0)
          transforms.push(`translateY(${keyframe.translateY}px)`);
        ...
        if (keyframe.opacity !== 1)
          properties.push(`opacity: ${keyframe.opacity}`);
...
.animated-element {
  ...
  const updateKeyframe = useCallback(
    (id: string, updates: Partial<AnimationKeyframe>) => {
      setState((prev) => ({
        ...prev,
  ...
  const resetAnimation = useCallback(() => {
    if (
      window.confirm(
        "Reset animation to default settings? This will clear all current keyframes."
      )
    ) {
  ...
  const previewStyle = {
    ...
    borderRadius:
      state.previewShape === "circle"
        ? "50%"
        : state.previewShape === "rounded"
        ? "8px"
        : "0px",
        ...
        <section className="mb-8 text-center">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground-light-secondary dark:text-foreground-dark-secondary mb-6 sm:mb-8">
              Create smooth CSS animations with custom keyframes, timing
              functions, and real-time preview
            </p>
          </div>
        </section>
        ...
        <section className="hidden xs:block mb-8 sm:mb-12 md:mb-16">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-foreground-light-secondary dark:text-foreground-dark-secondary max-w-2xl mx-auto">
              Professional animation tools for creating smooth, performant CSS
              animations
            </p>
          </div>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg border border-border-light bg-card-light p-6 dark:border-border-dark dark:bg-card-dark transition-all hover:shadow-lg">
              ...
              <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                See your animations come to life instantly as you adjust
                keyframes and timing properties.
              </p>
            </div>
            <div className="rounded-lg border border-border-light bg-card-light p-6 dark:border-border-dark dark:bg-card-dark transition-all hover:shadow-lg">
              ...
              <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                Define precise keyframes with transform properties, opacity,
                colors, and timing control.
              </p>
            </div>
            <div className="rounded-lg border border-border-light bg-card-light p-6 dark:border-border-dark dark:bg-card-dark transition-all hover:shadow-lg">
              ...
              <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                Start quickly with popular animation patterns like bounce, fade,
                slide, and rotate.
              </p>
            </div>
            <div className="rounded-lg border border-border-light bg-card-light p-6 dark:border-border-dark dark:bg-card-dark transition-all hover:shadow-lg">
              ...
              <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                Copy CSS code to clipboard or download as a file for easy
            ...
            <div className="rounded-lg border border-border-light bg-card-light p-6 dark:border-border-dark dark:bg-card-dark transition-all hover:shadow-lg">
              ...
              <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                Share your animations with team members via URL with all
                settings preserved.
              </p>
            </div>
            <div className="rounded-lg border border-border-light bg-card-light p-6 dark:border-border-dark dark:bg-card-dark transition-all hover:shadow-lg">
              ...
              <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                Intuitive sliders and controls for transforms, opacity, colors,
          ...
          <div className="mb-12">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none space-y-4">
              <p className="text-base sm:text-lg leading-relaxed">
                Our CSS Animation Generator is a comprehensive tool for creating
                smooth, professional animations using pure CSS keyframes.
                Whether you're building interactive web interfaces, adding
                micro-interactions, or creating engaging visual effects, this
                tool provides all the controls you need to craft perfect
                animations without writing code manually.
              </p>
              <p className="text-base sm:text-lg leading-relaxed">
                Built with performance in mind, the generator creates optimized
                CSS animations that work seamlessly across all modern browsers.
                All animations are processed client-side, ensuring your creative
                work remains private and secure. The tool supports advanced
                features like custom timing functions, multiple keyframes, and
                complex transform combinations.
              </p>
              <p className="text-base sm:text-lg leading-relaxed">
                Perfect for web designers, frontend developers, and anyone
                working on user interface animations. From simple fade effects
                to complex multi-step animations, create professional-quality
                CSS animations that enhance user experience without compromising
                performance.
              </p>
            </div>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                      Set your animation name, duration, timing function, delay,
                      and iteration count. Choose from preset timing functions
                      or use custom cubic-bezier curves for precise control over
                      animation easing.
                    </p>
                  </div>
                </div>
              ...
              <div className="border border-border-light dark:border-border-dark rounded-lg p-4 md:p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                      Add and customize keyframes using the visual editor.
                      Adjust transform properties like scale, rotation,
                      translation, opacity, background colors, and border radius
                      for each keyframe percentage.
                    </p>
                  </div>
                </div>
              </div>
              <div className="border border-border-light dark:border-border-dark rounded-lg p-4 md:p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                      Watch your animation play in real-time in the preview
                      area. Customize the preview element shape and size,
                      pause/play the animation, and make adjustments until you
              ...
              <div className="border border-border-light dark:border-border-dark rounded-lg p-4 md:p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                      Copy the generated CSS code to your clipboard or download
                      it as a file. Share your animation via URL with
                      colleagues, or save different variations for later use.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="border border-border-light dark:border-border-dark rounded-lg p-4">
                ...
                <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Intuitive interface for creating and editing keyframes with
                  real-time visual feedback and property controls.
                </p>
              </div>
              <div className="border border-border-light dark:border-border-dark rounded-lg p-4">
                <h3 className="font-semibold mb-2">Transform Properties</h3>
                <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Complete control over CSS transforms including translate,
                  scale, rotate, and skew operations.
                </p>
              </div>
              <div className="border border-border-light dark:border-border-dark rounded-lg p-4">
                <h3 className="font-semibold mb-2">Advanced Timing Control</h3>
                <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Precise timing functions, delays, iteration counts, and
              ...
              <div className="border border-border-light dark:border-border-dark rounded-lg p-4">
                ...
                <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Pre-built animation patterns for common effects like bounce,
                  fade, slide, rotate, pulse, and shake.
                </p>
              </div>
              <div className="border border-border-light dark:border-border-dark rounded-lg p-4">
                <h3 className="font-semibold mb-2">Real-time Preview</h3>
                <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Live animation preview with customizable preview element
                  shape, size, and playback controls.
                </p>
              </div>
              <div className="border border-border-light dark:border-border-dark rounded-lg p-4">
                <h3 className="font-semibold mb-2">Export Options</h3>
                <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Copy to clipboard or download CSS files with clean, optimized
            ...
            <div className="space-y-6">
              <div className="border border-border-light dark:border-border-dark rounded-lg p-6">
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary mb-4">
                  Create smooth scale and color transitions for interactive
                  buttons. Perfect for call-to-action elements that need subtle
              ...
              <div className="border border-border-light dark:border-border-dark rounded-lg p-6">
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary mb-4">
                  Infinite rotation animation for loading indicators. Use
                  continuous rotation with consistent timing for smooth,
              ...
              <div className="border border-border-light dark:border-border-dark rounded-lg p-6">
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary mb-4">
                  Slide and fade animations for smooth page transitions. Combine
                  translate and opacity changes for elegant content switching
                  effects.
                </p>
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                  <code className="text-sm">
            ...
            <div className="space-y-4">
              <details className="border border-border-light dark:border-border-dark rounded-lg">
                ...
                <div className="p-4 pt-0 text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  The generator supports all major CSS transform properties
                  (translate, scale, rotate), opacity, background-color, and
                  border-radius. These properties provide smooth,
                  hardware-accelerated animations that work efficiently across
              ...
              <details className="border border-border-light dark:border-border-dark rounded-lg">
                ...
                <div className="p-4 pt-0 text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  The tool includes several preset timing functions including
                  cubic-bezier curves. You can select from options like
                  ease-in-out, or use custom cubic-bezier functions for precise
                  easing control. Each timing function affects how the animation
              ...
              <details className="border border-border-light dark:border-border-dark rounded-lg">
                ...
                <div className="p-4 pt-0 text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Yes! You can add unlimited keyframes at any percentage point
                  from 0% to 100%. Each keyframe can have different property
                  values, allowing you to create complex multi-step animations
              ...
              <details className="border border-border-light dark:border-border-dark rounded-lg">
                ...
                <div className="p-4 pt-0 text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  The generated CSS uses standard @keyframes syntax supported by
                  all modern browsers. The animations work in Chrome, Firefox,
                  Safari, and Edge without requiring vendor prefixes or
                  polyfills.
                </div>
              </details>
              <details className="border border-border-light dark:border-border-dark rounded-lg">
                ...
                <div className="p-4 pt-0 text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Copy the generated CSS and add it to your stylesheet. Apply
                  the animation to any element by adding the class name (e.g.,
                  "animated-element") to your HTML element. You can also modify
                  the animation properties directly in the CSS as needed.
                </div>
              </details>
              <details className="border border-border-light dark:border-border-dark rounded-lg">
                <summary className="p-4 font-medium cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50">
                ...
                <div className="p-4 pt-0 text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Yes! The generator includes controls for animation delay (when
                  it starts), iteration count (how many times it repeats),
                  direction (normal, reverse, alternate), and fill mode (what
                  happens before and after animation).
                </div>
              </details>
              <details className="border border-border-light dark:border-border-dark rounded-lg">
                <summary className="p-4 font-medium cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50">
                ...
                <div className="p-4 pt-0 text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Each preset represents a common animation pattern: Bounce adds
                  scale and vertical movement, Fade In changes opacity, Slide In
                  combines translation with opacity, Rotate spins the element,
                  Pulse scales up and down, and Shake creates horizontal
              ...
              <details className="border border-border-light dark:border-border-dark rounded-lg">
                ...
                <div className="p-4 pt-0 text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  The tool generates animations using transform and opacity
                  properties, which are hardware-accelerated for smooth
                  performance. Avoid animating layout properties like
                  width/height, and prefer shorter durations for frequently
                  triggered animations. Use 'will-change: transform' in CSS for
                  complex animations.
                </div>
              </details>
            </div>
