                ...
                {(gradientType === 'linear' || gradientType === 'conic') && (
                  <div>
                    ...
                    <input
                      ...
                      max="360"
                      value={angle}
                      onChange={(e) => setHistoryState({ ...state, angle: Number(e.target.value) })}
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setHistoryState({ ...state, radialPosition: e.target.value })
                        }
                        className="w-full px-3 py-2 text-sm border border-border-light dark:border-border-dark rounded-lg bg-white dark:bg-background-dark"
                      >
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="rounded-lg bg-gray-50 dark:bg-gray-900 p-4">
                    <div
                      className="mb-3 h-20 rounded"
                      style={{ background: 'linear-gradient(45deg, #fa709a 0%, #fee140 100%)' }}
                    />
