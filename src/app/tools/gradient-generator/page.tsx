...
export default function GradientGeneratorPage() {
  ...
  useEffect(() => {
    ...
    const savedState =
      localStorageManager.load<GradientGeneratorState>(TOOL_NAME);
    if (savedState) {
  ...
  const parseGradientCSS = (
    css: string
  ): Partial<GradientGeneratorState> | null => {
          ...
          <section className="mb-6 xs:mb-8 sm:mb-12 md:mb-16 text-center">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mb-4 xs:mb-6 text-sm xs:text-base sm:text-lg text-foreground-light-secondary dark:text-foreground-dark-secondary px-2 xs:px-0">
                Create beautiful CSS gradients with live preview and custom
                controls.
              </p>
            </div>
          </section>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {(["linear", "radial", "conic"] as const).map((type) => (
                      <button
                        key={type}
                        onClick={() =>
                          setHistoryState({ ...state, gradientType: type })
                        }
            ...
            <div className="mb-12">
              ...
              <div className="prose prose-slate dark:prose-invert max-w-none">
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary leading-relaxed mb-4">
                  Our CSS Gradient Generator is a powerful tool for creating
                  beautiful, professional gradients for your web projects. CSS
                  gradients have become an essential part of modern web design,
                  allowing developers to create smooth color transitions without
                  the need for image files. This reduces load times, improves
                  scalability, and provides crisp visuals on all screen
                  densities including high-DPI displays.
                </p>
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary leading-relaxed mb-4">
                  The tool supports all three types of CSS gradients: linear
                  gradients for straight-line color transitions, radial
                  gradients for circular or elliptical patterns, and conic
                  gradients for cone-shaped color wheels. Each gradient type
                  offers unique possibilities for creative design, from subtle
                  background effects to bold graphical elements. The real-time
                  preview ensures you see exactly how your gradient will appear
                  in browsers.
                </p>
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary leading-relaxed">
                  With an intuitive color picker interface and precise control
                  over color stops and positions, you can create anything from
                  simple two-color fades to complex multi-color compositions.
                  The generated CSS is optimized for all modern browsers and can
                  be easily integrated into your stylesheets or CSS-in-JS
                  solutions.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    ...
                    Linear creates straight-line transitions, radial creates
                    circular patterns, and conic creates cone-shaped color
                    wheels.
                  </p>
                </div>
                <div className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    For linear gradients, set the angle. For radial gradients,
                    choose shape, size, and position. For conic gradients,
                    adjust the starting angle and center point.
                  </p>
                </div>
                <div className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <h3 className="font-semibold text-lg mb-2">
                  ...
                  <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Add, remove, and adjust color stops. Each stop has a color
                    and position percentage. Click colors to open the color
                    picker and drag positions to fine-tune the gradient.
                  </p>
                </div>
                <div className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <h3 className="font-semibold text-lg mb-2">
                  ...
                  <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Preview your gradient in real-time, then copy the generated
                    CSS code to use in your projects. Save favorite gradients as
                    presets for quick access later.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Support for linear, radial, and conic gradients with full
                ...
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    See changes instantly as you adjust colors, positions, and
                    gradient properties.
                  </p>
                </div>
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Add unlimited color stops with precise position control and
                ...
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Save your favorite gradients and quickly load them for
                    future projects.
                  </p>
                </div>
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Generate optimized CSS code that works across all modern
                    browsers.
                  </p>
                </div>
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Copy to clipboard or download as CSS file for easy
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="rounded-lg bg-gray-50 dark:bg-gray-900 p-4">
                    ...
                    <code className="text-xs bg-white dark:bg-gray-800 px-2 py-1 rounded">
                      background: linear-gradient(45deg, #fa709a 0%, #fee140
                      100%);
                    </code>
                  </div>
                </div>
                <div>
                  ...
                  <div className="rounded-lg bg-gray-50 dark:bg-gray-900 p-4">
                    ...
                    <code className="text-xs bg-white dark:bg-gray-800 px-2 py-1 rounded">
                      background: radial-gradient(circle at center, #ff6b6b 0%,
                      #4ecdc4 50%, #45b7d1 100%);
                    </code>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Linear gradients create straight-line color transitions in
                    any direction. Radial gradients create circular or
                    elliptical patterns radiating from a center point. Conic
                    gradients create cone-shaped color wheels, perfect for pie
                    charts or color wheels.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <summary className="font-semibold cursor-pointer">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    ...
                    Linear and radial gradients work in Internet Explorer 10+
                    and all versions of Chrome, Firefox, Safari, and Edge. Conic
                    gradients are supported in newer browser versions (Chrome
                ...
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Copy the generated CSS and apply it to any element's
                    background property. You can use it in regular CSS files,
                    inline styles, or CSS-in-JS solutions. The gradient will
                    automatically scale to fit the element's dimensions.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <summary className="font-semibold cursor-pointer">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Yes! Use the color picker to select colors with transparency
                    (alpha channel), or manually edit the CSS to use rgba() or
                    hsla() color values. This is perfect for overlay effects and
                    blending gradients with background content.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <summary className="font-semibold cursor-pointer">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    You can add as many color stops as needed. However, for
                    performance reasons, it's recommended to keep the number
                    reasonable (typically 2-10 stops). Too many stops might make
                    the gradient appear busy and can impact rendering
                    performance.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    For buttons, subtle gradients work best. Try angles between
                    0-45 degrees with colors that are close in hue but different
                    in brightness. A slight gradient from lighter at the top to
                    darker at the bottom (180deg) creates a natural,
                ...
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Yes, but with limitations. You can animate gradient
                    positions and some properties, but you cannot directly
                    animate between different gradient types. For smooth
                    animations, consider animating the background-position of a
                    larger gradient or using CSS transitions with opacity
                    overlays.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    CSS gradients are generally very efficient since they're
                    rendered by the GPU. They're much faster than loading image
                    files and scale perfectly to any size. Complex gradients
                    with many color stops may have a slight performance impact,
