...
export default function PasswordGeneratorPage() {
  ...
  useEffect(() => {
    ...
    const savedState =
      localStorageManager.load<PasswordGeneratorState>(TOOL_NAME);
    if (savedState) {
          ...
          <section className="mb-6 xs:mb-8 sm:mb-12 md:mb-16 text-center">
            <div className="mx-auto max-w-3xl">
              ...
              <p className="mb-4 xs:mb-6 text-sm xs:text-base sm:text-lg text-foreground-light-secondary dark:text-foreground-dark-secondary px-2 xs:px-0">
                Generate strong, unique passwords with customizable security
                options.
              </p>
            </div>
          </section>
                        ...
                        >
                          <div className="flex items-center justify-between mb-2">
                            ...
                            >
                              ...
                              {copiedIndex === passwords.indexOf(password)
                                ? "Copied!"
                                : "Copy"}
                            </button>
                          </div>
            ...
            <div className="mb-12">
              ...
              <div className="prose prose-slate dark:prose-invert max-w-none">
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary leading-relaxed mb-4">
                  Our Password Generator is a powerful, secure tool designed to
                  create strong, unique passwords that protect your online
                  accounts from unauthorized access. In today's digital world,
                  where data breaches and cyber attacks are increasingly common,
                  using strong, unique passwords for each of your accounts is
                  more important than ever. This tool uses cryptographically
                  secure random number generation to ensure your passwords are
                  truly unpredictable and resistant to hacking attempts.
                </p>
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary leading-relaxed mb-4">
                  The generator leverages the Web Crypto API, a browser-based
                  cryptographic standard that provides access to
                  cryptographically strong random values. Unlike pseudo-random
                  generators that might be predictable, this ensures your
                  passwords are generated with true randomness. All password
                  generation happens entirely in your browser - no passwords are
                  ever sent to our servers or stored anywhere online,
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary leading-relaxed">
                  With extensive customization options, you can generate
                  passwords that meet specific requirements for different
                  services. Whether you need a simple memorable password or a
                  highly complex string for maximum security, our tool adapts to
                  your needs. The built-in strength analyzer helps you
                  understand how secure your passwords are, while the batch
                  generation feature allows you to create multiple passwords at
                  once for different accounts.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Adjust the password length using the slider (4-128
                    characters). Select which character types to include:
                    uppercase, lowercase, numbers, and symbols. Enable "Exclude
                    similar" to avoid confusing characters like 'l' and '1'.
                  </p>
                </div>
                <div className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <h3 className="font-semibold text-lg mb-2">
                  ...
                  <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Choose how many passwords to generate at once (1-20). This
                    is useful when setting up multiple accounts or creating
                    backup passwords.
                  </p>
                </div>
                <div className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Click the "Generate" button to create your passwords. Each
                    password will be displayed with a strength indicator showing
                    how secure it is.
                  </p>
                </div>
                <div className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Click "Copy" next to any password to copy it to your
                    clipboard. Use the eye icon to show/hide passwords. Export
                    all passwords as JSON for backup.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Uses Web Crypto API for true random generation, not
                    predictable pseudo-random algorithms.
                  </p>
                </div>
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  <h3 className="font-semibold mb-2">Customizable Length</h3>
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Generate passwords from 4 to 128 characters to meet any
                ...
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Fine-tune character sets including custom symbols and
                ...
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Create up to 20 passwords at once for multiple accounts or
                    backup purposes.
                  </p>
                </div>
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Real-time password strength evaluation with visual
                ...
                <div className="rounded-lg bg-card-light dark:bg-card-dark p-4 border border-border-light dark:border-border-dark">
                  ...
                  <p className="text-sm text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    All generation happens locally in your browser. No passwords
                ...
                <div>
                  ...
                  <div className="rounded-lg bg-gray-50 dark:bg-gray-900 p-4">
                    <p className="text-sm mb-2">
                      Settings: 20 characters, all character types, exclude
                      similar
                    </p>
              ...
              <div className="space-y-4">
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Our passwords are cryptographically secure, using the Web
                    Crypto API which provides true random values. This is the
                    same technology used by security professionals and is
                    significantly more secure than pseudo-random generators.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <summary className="font-semibold cursor-pointer">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    No, passwords are never stored on our servers. They're
                    generated entirely in your browser and only temporarily
                    saved in your browser's local storage if you choose.
                    Clearing your browser data will remove any saved passwords.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <summary className="font-semibold cursor-pointer">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Strong passwords are long (12+ characters), use a mix of
                    uppercase, lowercase, numbers, and symbols, avoid dictionary
                    words and personal information, and are unique for each
                    account. Our generator ensures all these criteria can be
                    met.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Similar characters like 'l', '1', 'I', 'O', '0' can be
                    confused when reading or typing passwords. Excluding them
                    reduces errors when entering passwords manually, especially
                    with handwritten backups.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <summary className="font-semibold cursor-pointer">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Security experts now recommend changing passwords only when
                    there's a reason to (like a breach), rather than on a
                    schedule. Focus on using unique, strong passwords for each
                    account instead of frequent changes.
                  </p>
                </details>
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  <summary className="font-semibold cursor-pointer">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Yes, you can customize which symbols to include. Some
                    websites have restrictions on allowed symbols, so our custom
                    symbols feature lets you generate passwords that meet
                ...
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Our generator supports passwords up to 128 characters. While
                    most services don't require passwords this long, having the
                    option ensures compatibility with high-security systems and
                ...
                <details className="rounded-lg border border-border-light dark:border-border-dark p-4">
                  ...
                  <p className="mt-3 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                    Yes, we strongly recommend using a password manager to store
                    the unique passwords you generate. This allows you to use
                    complex, unique passwords for every account without having
