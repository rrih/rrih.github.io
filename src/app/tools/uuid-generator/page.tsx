...
export default function UUIDGenerator() {
  ...
  const generateUUIDv1 = (): string => {
    ...
    return `${timeLow}-${timeMid}-${timeHigh}-${clockSeq.slice(
      0,
      1
    )}${clockSeq.slice(1, 4)}-${mac}`;
  };
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
            Generate UUID/GUID v1, v4, and other versions for development and
          ...
          <section>
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <p className="text-lg mb-4 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                UUID (Universally Unique Identifier) or GUID (Globally Unique
                Identifier) is a 128-bit identifier used to uniquely identify
                information in computer systems. Our UUID Generator creates
                standards-compliant UUIDs that are guaranteed to be unique
              ...
              <p className="mb-4 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                UUIDs are essential in distributed systems, databases, software
                development, and any scenario where unique identification is
                crucial. They eliminate the need for a central authority to
                assign identifiers, making them perfect for distributed
                applications and microservices architectures.
              </p>
              <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                Our generator supports the most commonly used UUID versions and
                provides various formatting options to match your specific
                requirements. All generation happens locally in your browser,
                ensuring privacy and instant results without any external
                dependencies.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  <li>
                    <strong>Version 4 (Random):</strong> Most commonly used,
                    based on random or pseudo-random numbers
                  </li>
                  <li>
                    <strong>Version 1 (Time-based):</strong> Based on timestamp
                    and MAC address, includes time information
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-2 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  ...
                  <li>
                    Choose the format: standard, uppercase, without hyphens, or
                    with braces
                  </li>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark p-6">
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary mb-3">
                  The most widely used UUID version, generated using random or
                  pseudo-random numbers. Provides excellent uniqueness
                  guarantees with virtually no chance of collision.
                </p>
              ...
              <div className="rounded-lg border border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark p-6">
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary mb-3">
                  Generated using timestamp and MAC address information.
                  Provides temporal ordering and can be useful when you need to
                  know the generation time.
                </p>
                <ul className="text-sm space-y-1 text-foreground-light-secondary dark:text-foreground-dark-secondary">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mb-4 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  A UUID is a 128-bit (16-byte) value typically represented as
                  32 hexadecimal characters, displayed in five groups separated
                  by hyphens:
                </p>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  ...
                  <li>
                    Can generate 1 billion UUIDs per second for 85 years before
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark p-6">
                ...
                <ul className="text-sm space-y-2 text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  <li>
                    • Use UUID v4 for sensitive applications to avoid
                    information leakage
                  </li>
                  <li>
                    • Don't rely on UUIDs for security - they're identifiers,
                    not secrets
                  </li>
                  <li>
                    • Consider cryptographically secure random generators for
                    critical systems
                  </li>
                  <li>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  ...
                  Identifier) refer to the same concept. GUID is Microsoft's
                  term for the same 128-bit identifier standard. They are
                  functionally identical and can be used interchangeably.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  ...
                  identical UUID v4s is astronomically small (approximately 1 in
                  2^122). For practical purposes, UUIDs can be considered
                  unique. The chance of collision is so low that it's safer than
                  many other risks in computing.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  For most applications, UUID v4 (random) is recommended as it
                  provides excellent uniqueness without revealing any
                  information about the generator. Use UUID v1 only if you
                  specifically need the temporal ordering or timestamp
              ...
              <div>
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  UUIDs can be used as primary keys, especially in distributed
                  systems where central coordination is difficult. However,
                  they're larger than integer keys and may impact performance.
                  Consider your specific requirements for uniqueness,
              ...
              <div>
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Our generator uses JavaScript's crypto.getRandomValues() when
                  available, which provides cryptographically secure random
                  numbers. For non-security-critical applications, the standard
                  Math.random() fallback is sufficient for uniqueness
                  guarantees.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-foreground-light-secondary dark:text-foreground-dark-secondary">
                  Yes, UUIDs are URL-safe when using the standard format with
                  hyphens. They contain only hexadecimal characters (0-9, a-f)
                  and hyphens, which don't require URL encoding. This makes them
                  excellent for use in REST APIs and web applications.
                </p>
              </div>
            </div>
          </section>
